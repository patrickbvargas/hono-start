export const ATTACHMENT_ERRORS = {
	...
	TYPE_INACTIVE: "Tipo de anexo inativo não pode ser selecionado.",
	TYPE_MISMATCH: "Tipo de anexo não corresponde ao arquivo selecionado.",
	TYPE_NOT_FOUND: "Tipo de anexo não encontrado.",
	UPLOAD_FAILED: "Não foi possível enviar anexo.",
} as const;
