export const EMPLOYEE_ERRORS = {
	...
	GRANT_ACCESS_RESTORE_REQUIRED:
		"Este colaborador possui acesso revogado. Use restaurar acesso.",
	...
	RESTORE_ACCESS_FAILED: "Não foi possível restaurar o acesso do colaborador",
	RESTORE_ACCESS_UNAVAILABLE:
		"Este colaborador não possui acesso revogado ao sistema",
	RESET_PASSWORD_FAILED: "Não foi possível redefinir a senha do colaborador",
	RESET_PASSWORD_UNAVAILABLE:
		"Este colaborador ainda não possui conta de acesso ao sistema",
